...
const SidebarNavLink = ({ to, icon, text, disabled = false }: NavItemProps) => {
    if (disabled) {
        return (
            <div className="flex items-center p-2 text-gray-400 dark:text-gray-500 rounded-lg cursor-not-allowed group" title="Coming Soon">
                {icon}
...
const MobileNavLink = ({ to, icon, text, disabled = false }: NavItemProps) => {
    if (disabled) {
        return (
            <div className="inline-flex flex-col items-center justify-center px-5 text-gray-400 dark:text-gray-500 cursor-not-allowed" title="Coming Soon">
                {icon}
